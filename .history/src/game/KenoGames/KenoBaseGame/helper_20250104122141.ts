...
import { calculateRTP, examplePayoutTable, generatePaytables, hypergeometric } from "./rtp";
...
// //   7.5, // 10 matches
// // ];
// // const probaility = hypergeometric(80, 1, 20, 1);
// // console.log(probaility, "probability");
...
const paytable = [
  ...
  [0, 4.9, 12],                   // 3 picks
  [0, 3.3, 4, 6.5],               // 4 picks
  [0, 1.6, 4.3, 6.1, 8],          // 5 picks
  [0, 1.5, 2.1, 3.1, 4.6, 7],     // 6 picks
  [0, 0.6, 2.2, 4.4, 6, 8, 9],    // 7 picks
  [0, 0.9, 1.1, 3.1, 3.2, 4, 5, 6], // 8 picks
  [0, 0.5, 1.1, 3.2, 3.5, 4, 5, 6, 7], // 9 picks
  [0, 0.4, 0.2, 3.2, 3.5, 4, 5, 6, 7, 8], // 10 picks
];

const N = 80; // Total numbers
const n = 20; // Numbers drawn

const { paytables, rtps } = generatePaytables(N, n, paytable);

...
import { calculateRTP, examplePayoutMultiplier, examplePayoutTable, generatePaytables, hypergeometric } from "./rtp";
...
const N = 80;  // Total numbers in the pool
const n = 20;  // Numbers drawn
const maxPicks = 10; // Maximum number of picks by the player

// Generate paytables and RTP for all pick sizes
const { paytables, rtps } = generatePaytables(N, n, maxPicks, examplePayoutTable);

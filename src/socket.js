...
const getInstanceMetadata = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield fetch("http://169.254.169.254/latest/meta-data/instance-id");
        if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
        }
        const instanceId = yield response.text(); // Convert response to plain text
        return instanceId;
    }
    catch (error) {
...
const socketController = (io) => {
    ...
    io.use((socket, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const instanceId = yield getInstanceMetadata();

 ...
 */
function handleFullReelOfWild(gameInstance, symbolIdToCheck = 11) {
    try {
        const { settings } = gameInstance;
...
function getRandomValue(gameInstance, type) {
    ...
    if (type === 'main') {
        values = settings === null || settings === void 0 ? void 0 : settings.symbolsSet;
        probabilities = settings === null || settings === void 0 ? void 0 : settings.symbolsSetProb;
    }
    else if (type === 'collosal') {
        values = settings === null || settings === void 0 ? void 0 : settings.symbolsSetCollosal;
        probabilities = settings === null || settings === void 0 ? void 0 : settings.symbolsSetCollosalProb;
